...
$(document).ready(function(){
	$(".menu_down").hover(function(){$(this).children("dl").show(200);},function(){$(this).children("dl").hide();});//,function(){$(this).children("dl").hide()鼠标一出的效果，点击不需要
...
/*$(document).ready(function(){
	$(".menu_down").hover(function(){$(this).children(".menu>ul>li>ul").show(200);},function(){$(this).children(".menu>ul>li>ul").hide();});
	$(".menu>ul>li:last").css({background:"none",borderRight:"none"})
	$(".menu>ul>li").hover(function(){$(this).find("span a").addClass("menu_hover")},function(){$(this).find("span a").removeClass("menu_hover")})
})*/
